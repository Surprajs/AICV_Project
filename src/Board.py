...
class Board:
    ...
    def promotion(self):
        self.__board[7][:] = [Field.white_king if piece == Field.white else piece for piece in self.__board[7][:]]
        self.__board[0][:] = [Field.black_king if piece == Field.black else piece for piece in self.__board[0][:]]
